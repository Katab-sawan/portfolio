...
# Then force theme to dark (only works if Streamlit supports it)
st.markdown(
    """
    <style>
    /* Override some default styles to dark */
    .main {
...
if not exp_dates:
    ...
    if not option_data:
        ...
        st.write("---")
        st.markdown(
            "Created by Katab Sawan  |   [LinkedIn](https://www.linkedin.com/in/katab-sawan-60a2a8260/)"
            "   |   [GitHub](https://github.com/Katab-sawan/portfolio/tree/main/personal_projects)"
        )